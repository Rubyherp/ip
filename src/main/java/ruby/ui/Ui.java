...
/**
 * Handles console interaction for Ruby, formatting every message with a
 * consistent indentation and horizontal line.
 */
public class Ui {
    ...
    /**
     * Creates a console user interface for the Ruby chatbot.
     */
    public Ui() {
